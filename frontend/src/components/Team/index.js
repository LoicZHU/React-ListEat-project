  ...
  return (
    <main>
      ...
      <div id="hi-there">  
          ...
          <span><strong>Cette application web est le sujet de notre projet de fin de formation</strong> : nous avions un mois pour rédiger notre cahier des charges, cadrer notre projet, le développer et le mettre en ligne. Tout cela en partant de 0.</span>
        </div>
      <div id="team-container">
        <TeamMember name="Liza Ta" role="Scrum Master" linkedinURL="https://www.linkedin.com/in/liza-t-xls/" avatar={AvatarDamien} tech={LogoSymfony}/>
